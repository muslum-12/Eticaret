...
$kullanici_id=1;
echo $kullanici_ad=$kullanicicek['kullanici_ad']." ".$kullanicicek['kullanici_soyad'];
$kullanici_adsoyadp=explode(" ", $kullanici_ad,$kullanici_soyad);

$kullanici_ad=$kullanici_ad[0];
$kullanici_soyad=$kullanici_soyad[1];
...
$shippingAddress->setContactName("$kullanici_soyad");
...
$billingAddress->setContactName("$kullanici_soyad");
