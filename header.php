        ...
        <div class="col-md-8">
          <div class="pushright">
           <div class="top">
             ...
             <a href="#"  class="btn btn-default btn-dark">Hoşgeldin<span>--</span><?php echo $kullanicicek['kullanici_ad']." ".$kullanicicek['kullanici_soyad'] ?></a>
              <a href="logout.php"  class="btn btn-default btn-dark">Çıkış</a>
             ...
             <div class="regwrap">
               <div class="row">
                ...
                <form action="nedmin/netting/kullanici.php" method="POST" role="form">
             ...
             <div class="col-md-6">
              ...
              <p>
           Alışverişe başlamak için hemen kayıt olmalısın!
              </p>
         ...
         <div class="row">
          <div class="col-md-12">
           <form action="arama" method="POST"class="form-horizontal" role="form">
            <div class="form-group">
              <button class="btn btn-default btn-xs">Ara</button>
            <!-- <label for="search" class="col-sm-2 control-label"></label>-->
             <div class="col-sm-10">
              <input name="aranan" type="text" maxlength="5" class="form-control" id="search">
            </div>
          </div>
        </form>
      </div>
...
<div class="main-nav"><!--end main-nav -->
 <div class="navbar navbar-default navbar-static-top">
  ...
  <?php 
      ...
      <td><a href="product.htm">Adı:<?php echo $uruncek['urun_ad']; ?></a></td>
      <td>Adet:<?php echo $sepetcek['urun_adet'] ?></td>
      <td>Fiyat:<?php echo $uruncek['urun_fiyat']; ?></td>
    </tr>
<?php } ?>
